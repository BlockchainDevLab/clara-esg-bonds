...
library NFTRenderer {
    ...
    function renderBackground(string memory owner, int24 lowerTick, int24 upperTick)
        internal
        pure
    ...
    function renderTop(string memory code, string memory codeISIN, string memory name)
        internal
        pure
    ...
    function renderBottom(uint256 amount, string memory fee, string memory maturityDate)
        internal
        pure
